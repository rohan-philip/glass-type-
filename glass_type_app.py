...
st.set_option("Depication.showPyplotGlobalUse",False)
...
boxplot_features=st.sidebar.multiselect("Select features to create boxplot",('RI', 'Na', 'Mg', 'Al', 'Si', 'K', 'Ca', 'Ba', 'Fe',"GlassType"))
